...
<head>
    ...
    <link href="<?= base_url("bower_components/angular-bootstrap-calendar/dist/css/angular-bootstrap-calendar.min.css") ?>" type="text/css">
...
<!--                <span class="icon-bar"></span>-->
<!--            </button>-->
<!--            <a class="navbar-brand" href="--><?//= base_url()?><!--">Maestría</a>-->
<!--        </div>-->
<!--        <!-- /.navbar-header -->
<!---->
